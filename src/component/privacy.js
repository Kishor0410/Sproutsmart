...
function Privacy() {
  return (
    ...
    <div style={{ padding: '20px',width:"88%",margin:0,alignItems:"center",justifyContent:"center"
        ,backgroundColor:"aliceblue"
        }}>
    <h1 style={{margin:"0%",marginLeft:"480px"}}>Privacy Policy</h1>
    <br /><p>
    ...
    <h2 style={{color:"green"}}>1. Collection of Personally Identifiable Information and other Information</h2>
    <p>
    ...
    <h2 style={{color:"green"}}>2. Use of Demographic / Profile Data / Your Information</h2>
    <p>
    ...
    <h2 style={{color:"green"}}>Cookies</h2>
    <p>
    ...
    <h2 style={{color:"green"}}>3. Sharing of personal information</h2>
    <p>
    ...
    <h2 style={{color:"green"}}>4. Links to Other Sites</h2>
    <p>
      Our Website links to other websites that may collect personally identifiable information about you. BigHaat.com is not responsible for the privacy practices or the content of those linked websites.
    </p>
    <h2 style={{color:"green"}}>5. Security Precautions</h2>
    <p>
      Our Website has stringent security measures in place to protect the loss, misuse, and alteration of the information under our control. Whenever you change or access your account information, we offer the use of a secure server. Once your information is in our possession we adhere to strict security guidelines, protecting it against unauthorized access.
    </p>
    <h2 style={{color:"green"}}>6. Your Consent</h2>
    <p>
    ...
    <h2 style={{color:"green"}}>7. Grievance Officer</h2>
    <p>
      In accordance with Information Technology Act 2000 and rules made there under, the name and contact details of the Grievance Officer are provided below:
    </p>
    <p>
    SPROUTSMART Pvt Ltd, Sri krishna college of Engineering and Technology,Kunimuthur,Coimbatore - 641008,Tamil Nadu 
      <br />
      Phone: +91- 6380087037
      <br />
      Email: manikannan6380@gmail.com
      <br />
      Time: Mon to Fri (10:00 AM to 5:00 PM)
    </p>
    <h2 style={{color:"green"}}>8. Questions?</h2>
    <p>
      Please Contact us regarding any questions regarding this statement on the above address.
    </p>
  </div>
  </div>
  )
